...
//My code is different which I think is fine, but I'm leaving this message just in case isn't to clarify. Me and my group did work with each other and my code was very similar to theirs for a while, eventually though I felt kinda stumped on helping the person
//sharing their screen, so I tried having a go at the code directly myself so that I could think of how to progress, and doing so I was able to help a bit more. I hope that is OK! I also stayed up a bit to work on this because I got too focused on wanting to solve this. 
